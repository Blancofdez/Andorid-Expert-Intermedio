package com.blancofdez.horosapp.ui.detail

import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.blancofdez.horosapp.domain.model.HoroscopeModel
import com.blancofdez.horosapp.domain.usecase.GetPredictionUseCase
...
class HoroscopeDetailViewModel @Inject constructor(private val getPredictionUseCase: GetPredictionUseCase) :
    ...
    fun getHoroscope(sign: HoroscopeModel){
        ...
        viewModelScope.launch {
            ...
            //CODIGO EN HILO PRICIPAL -------------------------
            _state.value = HoroscopeDetailState.Loading

            //CODIGO EN HILO SECUNDARIO ---------------------
